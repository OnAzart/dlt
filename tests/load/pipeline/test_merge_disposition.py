...
def test_insert_only_with_nested_tables(destination_config: DestinationTestConfiguration) -> None:
    ...
    # Check parent table
    parent_tables = load_tables_to_dicts(p, "parent_items", "parent_items__children", exclude_system_cols=True)
